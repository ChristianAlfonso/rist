    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES['student_file'])) {
        ...
        if (($handle = fopen($file, "r")) !== FALSE) {
            ...
            while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
                ...
                $school_year = mysqli_real_escape_string($conn, $data[7]); // add school year
                $username = mysqli_real_escape_string($conn, $data[8]);
                $password = password_hash(mysqli_real_escape_string($conn, $data[9]), PASSWORD_DEFAULT);
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" action="change_password.php">
                                            ...
                                            <a class="btn btn-dark" href="<?php echo (isset($_SESSION['student_logged_in']) ? "student_dashboard.php" : (isset($_SESSION['parent_logged_in']) ? "parent_dashboard.php" : (isset($_SESSION['admin_logged_in']) ? "import_students.php" : ""))); ?>">Cancel</a>
                                        </form>
