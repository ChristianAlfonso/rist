        ...
        <div class="container-fluid shadow p-5">
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="first_name" value="<?php echo htmlspecialchars($parent['first_name']); ?>" required>
                </div>
                
                <div class="form-group">
                    <label for="last_name">Last Name:</label>
                    <input class="form-control" type="text" name="last_name" value="<?php echo htmlspecialchars($parent['last_name']); ?>" required>
                </div>


                <div class="form-group">
                    <label for="middle_initial">Middle Initial:</label>
                    <input class="form-control" type="text" name="middle_initial" value="<?php echo htmlspecialchars($parent['middle_initial']); ?>" maxlength="1">
                </div>

                <div class="form-group">
                    <label for="email">Email:</label>
                    <input class="form-control" type="email" name="email" value="<?php echo htmlspecialchars($parent['email']); ?>" required>
                </div>

                <div class="form-group">
                    <label for="lrn_students">LRN of Student:</label>
                    <input class="form-control" type="text" name="lrn_students" value="<?php echo htmlspecialchars($parent['lrn_students']); ?>" required>
                </div>

                <div class="form-group">
                    <button class="btn btn-danger" type="submit">Update Parent</button>
                    <a class="btn btn-dark" href="users_parents.php">Cancel</a><
                </div>
