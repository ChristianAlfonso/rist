...
<body>
    ...
    <div class="admin-user-parent d-flex">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" action="change_password.php">
                                            ...
                                            <a class="btn btn-dark" href="<?php echo (isset($_SESSION['student_logged_in']) ? "student_dashboard.php" : (isset($_SESSION['parent_logged_in']) ? "parent_dashboard.php" : (isset($_SESSION['admin_logged_in']) ? "users_parents.php" : ""))); ?>">Cancel</a>
                                        </form>
                ...
                <table class="table table-striped table-bordered nowrap" id="example">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-dark" href="edit_parent.php?id=<?php echo urlencode($row['id']); ?>">Edit</a> 
                                <a class="btn btn-danger" href="users_parents.php?delete_id=<?php echo urlencode($row['id']); ?>" onclick="return confirm('Are you sure you want to delete this parent?');">Delete</a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
